...
function resetForm(){
    clearErrors();
    document.forms["contactUs"]["num1"].value="";
    document.forms["contactUs"]["num2"].value="";
    document.getElementById("results").style.display = "none";
    document.getElementById("submitButton").innerText = "Submit";
    document.forms["contactUs"]["num1"].focus();
}

function validateItems() {
    clearErrors();
    var num1 = document.forms["contactUs"]["num1"].value;
    var num2 = document.forms["contactUs"]["num2"].value;

    if (num1 == "" || isNaN(num1)) {
        alert("Num1 must be filled in with a number.");
        document.forms["contactUs"]["num1"]
   ...
   if (num2 == "" || isNaN(num2)) {
       ...
       document.forms["contactUs"]["num2"]
          .parentElement.className = "form-group has-error"
       document.forms["contactUs"]["num2"].focus();
       return false;
   }
